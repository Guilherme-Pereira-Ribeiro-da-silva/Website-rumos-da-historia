...
<header>
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <img src='/images/logoloja.ico' class='rounded logo'>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link " href="/alunos/home">Home <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="#agendamento">Agendar Aula</a>
                        <a class="dropdown-item" href="#minhas-aulas">Minhas Aulas</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" id="a-sair" href="/sair">Sair</a>
                    </div>
                </li>
            </ul>
        </div>
